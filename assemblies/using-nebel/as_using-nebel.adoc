...
[id="using-nebel"]
= Using nebel to generate Asciidoc files
...
include::../../modules/using-nebel/p_setting-up.adoc[leveloffset=+1]

include::../../modules/using-nebel/p_setting-up-python.adoc[leveloffset=+1]

include::../../modules/using-nebel/p_setting-up-nebel.adoc[leveloffset=+1]
